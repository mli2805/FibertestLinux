...
public sealed class Boot : IHostedService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _logger.Log(LogLevel.Information, Logs.DataCenter.ToInt(), $"Fibertest RTU service {info.FileVersion}");
        return Task.CompletedTask;
    }

    public Task StopAsync(CancellationToken cancellationToken)
    {
        _logger.Log(LogLevel.Information, Logs.DataCenter.ToInt(), "Leave Fibertest RTU service");
        return Task.CompletedTask;
    }
}