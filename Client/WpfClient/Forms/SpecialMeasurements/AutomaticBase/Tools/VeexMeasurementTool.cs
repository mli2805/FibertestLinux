...
namespace Fibertest.WpfClient
{
    public class VeexMeasurementTool
    {
        ...
        private readonly ILogger<VeexMeasurementTool> _logger; 
        private readonly CurrentUser _currentUser;
        private readonly Model _readModel;
        private readonly IWcfServiceCommonC2D _c2DWcfCommonManager;

        public VeexMeasurementTool(IWritableConfig<ClientConfig> config, ILogger<VeexMeasurementTool> logger, CurrentUser currentUser, Model readModel, IWcfServiceCommonC2D c2DWcfCommonManager)
        {
            _config = config;
            _logger = logger;
