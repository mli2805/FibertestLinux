...
using GMap.NET.Etc;
using GMap.NET.Here;
using GMap.NET.Korea;
using GMap.NET.Lithuania;
using GMap.NET.NearMap;
using GMap.NET.SocksProxySocket;
using GMap.NET.UMP;
using GMap.NET.Yahoo;
using GMap.NET.Yandex;
...
namespace GMap.NET
{
    ...
    public abstract class GMapProvider
    {
        ...
        /// </summary>
        public static PureImageProxy TileImageProxy = DefaultImageProxy.Instance;
