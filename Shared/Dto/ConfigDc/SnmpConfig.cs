...
public class SnmpConfig
{
    ...
    public void FillIn(SnmpConfig other)
    {
        IsSnmpOn = other.IsSnmpOn;
        SnmpTrapVersion = other.SnmpTrapVersion;
        SnmpReceiverIp = other.SnmpReceiverIp;
        SnmpReceiverPort = other.SnmpReceiverPort;
        SnmpAgentIp = other.SnmpAgentIp;
        SnmpCommunity = other.SnmpCommunity;
        EnterpriseOid = other.EnterpriseOid;
    }
}